...
class MLQuickImplementation(BaseProperty):
    ...
    def _serialize(self):
        """
        Creates the actual ML Predict workflow that will be output
        """
        subworkflow_names = ["JobSetup",
                             "Preprocessing",
        ...
        workflow = {
            ...
            "units": [
                {
                    "_id": "LCthJ6E2QabYCZqf4",  # Todo: How do I get a unique ID? Can this be an empty string as below?
